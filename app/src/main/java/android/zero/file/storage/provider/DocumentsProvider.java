...
import static android.zero.file.storage.model.DocumentsContract.METHOD_COMPRESS_DOCUMENT;
import static android.zero.file.storage.model.DocumentsContract.METHOD_COPY_DOCUMENT;
import static android.zero.file.storage.model.DocumentsContract.METHOD_CREATE_DOCUMENT;
import static android.zero.file.storage.model.DocumentsContract.METHOD_DELETE_DOCUMENT;
import static android.zero.file.storage.model.DocumentsContract.METHOD_IS_CHILD_DOCUMENT;
import static android.zero.file.storage.model.DocumentsContract.METHOD_MOVE_DOCUMENT;
import static android.zero.file.storage.model.DocumentsContract.METHOD_REMOVE_DOCUMENT;
import static android.zero.file.storage.model.DocumentsContract.METHOD_RENAME_DOCUMENT;
import static android.zero.file.storage.model.DocumentsContract.METHOD_UNCOMPRESS_DOCUMENT;
import static android.zero.file.storage.model.DocumentsContract.METHOD_UPLOAD_DOCUMENT;
import static android.zero.file.storage.model.DocumentsContract.buildDocumentUri;
import static android.zero.file.storage.model.DocumentsContract.buildDocumentUriMaybeUsingTree;
import static android.zero.file.storage.model.DocumentsContract.buildTreeDocumentUri;
import static android.zero.file.storage.model.DocumentsContract.getDocumentId;
import static android.zero.file.storage.model.DocumentsContract.getRootId;
import static android.zero.file.storage.model.DocumentsContract.getSearchDocumentsQuery;
import static android.zero.file.storage.model.DocumentsContract.getTreeDocumentId;
import static android.zero.file.storage.model.DocumentsContract.isTreeUri;
...
*/
    ...
    private int enforceReadPermission(Uri uri, IBinder callerToken)
        ...
        final int mode = enforceReadPermissionInner2(uri, callerToken);
    ...
    private int enforceWritePermission(Uri uri, IBinder callerToken)
            throws SecurityException {
        final int mode = enforceWritePermissionInner1(uri, callerToken);
        if (mode != MODE_ALLOWED) {
            return mode;
        }
 ...
 //  @Override
    protected int enforceReadPermissionInner2(Uri uri, IBinder callerToken)
            throws SecurityException {
        return MODE_ALLOWED;
    }

   // @Override
    protected int enforceWritePermissionInner1(Uri uri, IBinder callerToken)
            throws SecurityException {
        return MODE_ALLOWED;
    }
