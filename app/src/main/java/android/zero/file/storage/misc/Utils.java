...
public class Utils extends UtilsFlavour{
    ...
    public static boolean isProVersion(){
        return false;
        //BuildConfig.FLAVOR.contains("Pro") || BuildConfig.FLAVOR.contains("Underground");
    }

    public static boolean isOtherBuild(){
        return false;
        // BuildConfig.FLAVOR.contains("other");
    }

    public static boolean isGoogleBuild(){
        return false; 
        //BuildConfig.FLAVOR.contains("google");
    }

    public static boolean isAmazonBuild(){
        return false;
        // BuildConfig.FLAVOR.contains("amazon");
    }

    public static Uri getAppUri(){
        if(isAmazonBuild()){
            return null;
            //Uri.parse("amzn://apps/android?p=" + BuildConfig.APPLICATION_ID);
        }
