...
import static android.zero.R.id.action_close;
import static android.zero.R.id.action_feedback;
import static android.zero.R.id.action_rate;
import static android.zero.R.id.action_support;
...
if (viewId == action_close) {
    ...
    editor.apply();
} else if (viewId == action_feedback) {
    openFeedback(activity);
    hideAllViews(mainView);
    editor.putBoolean(KEY_CLICKED, true);
    editor.apply();
} else if (viewId == action_support) {
