...
import android.zero.file.storage.adapter.TransferAdapter;
...
import android.zero.file.storage.transfer.model.TransferStatus;
import android.zero.file.storage.ui.CircleImage;
...
import static android.zero.file.storage.transfer.TransferHelper.EXTRA_STATUS;
import static android.zero.file.storage.transfer.TransferHelper.EXTRA_TRANSFER;
import static android.zero.file.storage.transfer.TransferHelper.TRANSFER_UPDATED;
...
public class TransferFragment extends RecyclerFragment
    ...
    int  getitem =item.getItemId();
                if(getitem == R.id.action_show_devices){
