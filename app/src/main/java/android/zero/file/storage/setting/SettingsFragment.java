package android.zero.file.storage.setting;
...
import static android.zero.file.storage.setting.SettingsActivity.KEY_ACCENT_COLOR;
import static android.zero.file.storage.setting.SettingsActivity.KEY_ADVANCED_DEVICES;
import static android.zero.file.storage.setting.SettingsActivity.KEY_FILE_HIDDEN;
import static android.zero.file.storage.setting.SettingsActivity.KEY_FILE_SIZE;
import static android.zero.file.storage.setting.SettingsActivity.KEY_FILE_THUMBNAIL;
import static android.zero.file.storage.setting.SettingsActivity.KEY_FOLDER_ANIMATIONS;
import static android.zero.file.storage.setting.SettingsActivity.KEY_FOLDER_SIZE;
import static android.zero.file.storage.setting.SettingsActivity.KEY_PRIMARY_COLOR;
import static android.zero.file.storage.setting.SettingsActivity.KEY_RECENT_MEDIA;
import static android.zero.file.storage.setting.SettingsActivity.KEY_ROOT_MODE;
import static android.zero.file.storage.setting.SettingsActivity.KEY_SECURITY_ENABLED;
import static android.zero.file.storage.setting.SettingsActivity.KEY_THEME_STYLE;
