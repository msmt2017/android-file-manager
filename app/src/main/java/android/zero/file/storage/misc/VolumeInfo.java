...
import static android.zero.file.storage.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public static String getMediaEjecting() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            return Environment.MEDIA_EJECTING;
        } else {
            return "";
        }
    }
    static {
        ...
        sStateToEnvironment.put(VolumeInfo.STATE_EJECTING, getMediaEjecting());
    sEnvironmentToBroadcast.put(getMediaEjecting(), Intent.ACTION_MEDIA_EJECT);
