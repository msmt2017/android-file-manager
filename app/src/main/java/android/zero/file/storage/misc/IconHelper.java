...
import android.zero.file.storage.BaseActivity.State.ViewMode;
import android.zero.file.storage.DocumentsApplication;
import android.zero.R;
import android.zero.file.storage.libcore.util.BiConsumer;
import android.zero.file.storage.libcore.util.Consumer;
