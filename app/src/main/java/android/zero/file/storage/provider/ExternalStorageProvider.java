...
import android.zero.file.storage.misc.DiskInfo;
...
import android.zero.file.storage.misc.StorageVolume;
import android.zero.file.storage.misc.Utils;
import android.zero.file.storage.misc.VolumeInfo;
...
import static android.zero.file.storage.misc.FileUtils.getTypeForFile;
import static android.zero.file.storage.model.DocumentInfo.getCursorString;
import static android.zero.file.storage.provider.UsbStorageProvider.ROOT_ID_USB;
        ...
        public void onEvent(int event, String path) {
            if ((event & NOTIFY_EVENTS) != 0) {
                ...
                switch ((event & NOTIFY_EVENTS)){
                    ...
                    case CREATE:
                    case DELETE:
                        mResolver.notifyChange(mNotifyUri, null);
