package android.zero.file.storage.service;
...
import android.zero.file.storage.misc.LogUtils;
import android.zero.file.storage.misc.Utils;
import android.zero.file.storage.server.TransferServer;
...
import android.zero.file.storage.transfer.model.Bundle;
import android.zero.file.storage.transfer.model.FileItem;
import android.zero.file.storage.transfer.model.Transfer;

import static android.zero.file.storage.transfer.TransferHelper.ACTION_BROADCAST;
import static android.zero.file.storage.transfer.TransferHelper.ACTION_REMOVE_TRANSFER;
import static android.zero.file.storage.transfer.TransferHelper.ACTION_START_LISTENING;
import static android.zero.file.storage.transfer.TransferHelper.ACTION_START_TRANSFER;
import static android.zero.file.storage.transfer.TransferHelper.ACTION_STOP_LISTENING;
import static android.zero.file.storage.transfer.TransferHelper.ACTION_STOP_TRANSFER;
import static android.zero.file.storage.transfer.TransferHelper.EXTRA_DEVICE;
import static android.zero.file.storage.transfer.TransferHelper.EXTRA_ID;
import static android.zero.file.storage.transfer.TransferHelper.EXTRA_TRANSFER;
import static android.zero.file.storage.transfer.TransferHelper.EXTRA_URIS;
import static android.zero.file.storage.transfer.TransferHelper.getAssetFileDescriptor;
import static android.zero.file.storage.transfer.TransferHelper.getFilename;
import static android.zero.file.storage.transfer.TransferHelper.traverseDirectory;
