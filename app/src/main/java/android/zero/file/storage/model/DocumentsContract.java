...
import android.zero.file.storage.misc.ImageUtils;
import android.zero.file.storage.misc.OsCompat;
import android.zero.file.storage.misc.Utils;
import android.zero.file.storage.provider.DocumentsProvider;
import android.zero.file.storage.provider.ExternalStorageProvider;
import android.zero.file.storage.provider.UsbStorageProvider;

import static android.zero.file.storage.misc.ContentProviderClientCompat.buildAssetFileDescriptor;
import static android.zero.file.storage.misc.ContentProviderClientCompat.openTypedAssetFileDescriptor;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "android.zero.file.storage.action.DOCUMENTS_PROVIDER";
     ...
     * {@link android.zero.file.storage.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link android.zero.file.storage.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link android.zero.file.storage.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link android.zero.file.storage.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link android.zero.file.storage.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link android.zero.file.storage.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link android.zero.file.storage.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
