...
import android.zero.file.storage.adapter.CommonInfo;
import android.zero.file.storage.adapter.HomeAdapter;
import android.zero.file.storage.common.DialogBuilder;
import android.zero.file.storage.common.RecyclerFragment;
import android.zero.file.storage.cursor.LimitCursorWrapper;
...
import static android.zero.file.storage.adapter.HomeAdapter.TYPE_MAIN;
import static android.zero.file.storage.adapter.HomeAdapter.TYPE_RECENT;
import static android.zero.file.storage.adapter.HomeAdapter.TYPE_SHORTCUT;
import static android.zero.file.storage.misc.AnalyticsManager.FILE_TYPE;
import static android.zero.file.storage.model.RootInfo.openRoot;
import static android.zero.file.storage.provider.AppsProvider.getRunningAppProcessInfo;
...
if (viewId == R.id.recents) {
    DocumentsActivity activity = ((DocumentsActivity) getActivity());
    openRoot(activity, roots.getRecentsRoot(), mHomeRoot);
} else if (viewId == R.id.action) {
